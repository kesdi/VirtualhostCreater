...
printf  "****** \033[0;33m PARAMETRELERi SORDUKCA YAZIN DAHA SORUNSUZ OLUR \033[0m ******"
...
echo "Kullanici Adi (8 karakter):"
read -r username

printf "Sifre \033[0;33m (mkpasswd ile olusturulmus)\033[0m:"
read -r password
...
echo 178.210.177.210 $domainname $( echo $domainname | sed -e "s/\.com//g" ) >> /etc/hosts
